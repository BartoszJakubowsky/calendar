...
function MainPage({className}) 
{
    ...
    return <div className="h-screen ">
            <Menu className='flex'/>
            <m.div className={'flex flex-wrap justify-center mt-[40%] md:mt-[20%]'} layout initial={{y: '100%'}} animate={{y: "0%"}} transition={{type: 'spring', stiffness: 110, damping: 12}} exit={currentPath === '/logowanie'?{ opacity: 0, transition: 0.2} : {opacity: 0, x: 0, y: -100, transition: 0.2}}>
                    {createCalendarCard}
