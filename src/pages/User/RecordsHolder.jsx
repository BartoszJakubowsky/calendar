...
export default function RecordHolder({month}) 
{
    ...
    return (
        <div className="flex flex-col w-full h-full">
            <div className="flex flex-col justify-center items-center w-full  border-slate-400 bg-blue-100 border-b-2 border-x-2 ">
                <h4>{monthName}</h4>
                <h4>{year}</h4>
            </div>
            <div className="flex bg-white flex-wrap h-full py-5 justify-center border-b-2 border-x-2 border-slate-300">
